 ...
 * +---------------------------------------------------------------------------------+
 * |LALT|TD_WIN|RCTRL|SPACEFN |TD_CTRLFN| SPACE |OSL(FN1)|CNTXT|RCTRL|LEFT|DQN|  RGHT|
 * +---------------------------------------------------------------------------------+
 */
  [_BASE] = LAYOUT_65(
    ...
    KC_LCTL, TD(TD_WIN),KC_LALT, SPACEFN, KC_RCTL,                   KC_SPC,  XXXXXXX, OSL(_FN1), KC_RCMD, KC_RGUI, KC_LEFT, KC_DOWN, KC_RGHT
  ),

  [_FN1] = LAYOUT_65(
    KC_TILD, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  XXXXXXX,  _______, KC_INS, \
    RGB_TOG, RGB_MOD, _______, KC_UP,   _______, _______, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, _______, _______, KC_DEL, \
